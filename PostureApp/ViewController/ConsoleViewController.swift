...
//
//    func reformatData(notification: Notification) -> Any{
//
////        print(notification)
...
//    }
    ...
    var stateIsCompleted = true;

  @objc func appendRxDataToTextView(notification: Notification) -> Void{
//    consoleTextView.text.append("\n[Recv]: \(notification.object!) \n")
//    consoleTextView.text.append("\n[Recv]: \notification \n")
    // if (somehowdetermine it's combined)
    // call convert data on function()
    // replace converted data to the UI
    // local storage
    print(("\n[Recv]: \notification \n"))
  }
